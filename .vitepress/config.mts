...
function getThemeConfig() {
  return {
    logo: {src: '/openkcm-logo.svg', width: 24, height: 24},
    nav: getNavConfig(),
    sidebar: {
      ...
      '/docs/': { //generateEnhancedDocsSidebar()['/docs/'],
        ...
        "items": [
          {
            "text": "OPenKCM",
            "link": "openkcm/index.md",
            "items": [
              {
                "text": "Concepts",
                "link": "openkcm/concepts/index.md",
              }
            ]
          }
        ],
    ...
    socialLinks: [
      ...
      },
      {
        ...
        link: 'https://join.slack.com/t/openkcm/shared_invite/zt-33c9daems-3oOorhnqOSnldZPWqGmIBw'
      },
      {
        icon: {
...
function getHeadConfig(){
  return [
    [
      'link',
      {rel: 'icon', type: 'image/svg+xml', href: '/documentation/openkcm-logo.svg'}
    ],
    [
      'link',
      {rel: 'icon', type: 'image/png', href: '/openkcm-logo.svg'}
    ],
    ['meta', {name: 'theme-color', content: '#009f76'}],
    ['meta', {property: 'og:type', content: 'website'}],
    ['meta', {property: 'og:site_name', content: 'OpenKCM'}],
    [
      'meta',
      {
        property: 'og:image',
